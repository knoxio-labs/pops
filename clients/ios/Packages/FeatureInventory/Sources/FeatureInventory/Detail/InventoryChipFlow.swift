...
/// Chips that wrap onto as many lines as they need, so the whole set is
/// always on screen and grows taller rather than clipping when Dynamic Type
/// makes each chip wider.
