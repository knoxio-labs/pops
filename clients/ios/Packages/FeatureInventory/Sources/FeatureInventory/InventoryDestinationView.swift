...
/// lands on a blank page. Item detail, containers and locations have moved;
/// most screens have not yet: the items browser and In hand (POPS-4065),
/// Sync and repair (POPS-4074), and the scanner (POPS-4078). Until each
