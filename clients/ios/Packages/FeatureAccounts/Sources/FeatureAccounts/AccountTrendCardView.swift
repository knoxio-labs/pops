...
/// rose or fell: a loan's series is negative and stays the destructive tone
/// even as it climbs toward zero, because it is still debt. Colouring by
/// direction would paint a shrinking debt the same green as a growing
/// balance. Points stay neutral regardless of sign.
