...
private final class KeySequence: Sendable {
...
private actor ReviewWriteRepository: ReceiptCaptureRepository {
    fileprivate enum Route: Equatable, Sendable {
        case draft
        case manual
    }

    fileprivate private(set) var routes: [Route] = []
    fileprivate private(set) var savedDrafts: [ReceiptDraftSavePayload] = []
