...
| `inventory-smoke.yaml`                          | Inventory downloads from the real inventory pillar, then creates a place and an item, moves it, discards it and undoes the discard, each write round-tripping the pillar. |
