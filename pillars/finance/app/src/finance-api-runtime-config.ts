 ...
 *
 * Forces the base URL to the shell's `/finance-api` proxy path, which vite
 * (dev) and the production reverse proxy both map onto the deployed finance
 * pillar on port 3004. This is unconditional — a `baseUrl` passed in here is
