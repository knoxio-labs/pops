 ...
 * when contacts could not be reached (POPS-2692) — a row deliberately left
 * unassigned, or matched with no entity at all, commits fine and is not one of
 * these (POPS-3748) — or they are credits nobody has typed, which the pillar
