...
`/accounts/:id/checkpoints` (POPS-2888). The flag differs from a red liability in **shape**, not
colour: a badge with an icon and a claim, because a card that owes money is already red.
