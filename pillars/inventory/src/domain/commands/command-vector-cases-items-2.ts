...
export const ITEM_COMMAND_VECTOR_CASES_2: readonly CommandVectorCase[] = [
  ...
  {
    name: 'item.setOverride',
    op: 'item.setOverride',
    seedComputedOverrides: true,
    seedItems: [{ id: ITEM_LAMP, name: 'Lamp', placement: { kind: 'hand' }, typeKey: 'bulb' }],
    mutation: {
      ...
      catalogueRevision: 2,
      dependsOn: [],
      args: { fieldId: '40000000-0000-4000-8000-000000000001', values: [false] },
    },
  },
  {
    name: 'item.clearOverride',
    op: 'item.clearOverride',
    seedComputedOverrides: true,
    seedItems: [{ id: ITEM_LAMP, name: 'Lamp', placement: { kind: 'hand' }, typeKey: 'bulb' }],
    pre: [
      {
        mutationId: '30000000-0000-4000-8000-0000000000fc',
        op: 'item.setOverride',
        entityId: ITEM_LAMP,
        baseRevision: 1,
        catalogueRevision: 2,
    ...
    mutation: {
      mutationId: '30000000-0000-4000-8000-000000000016',
      op: 'item.clearOverride',
      entityId: ITEM_LAMP,
      baseRevision: 2,
      catalogueRevision: 2,
      dependsOn: [],
      args: { fieldId: '40000000-0000-4000-8000-000000000001' },
    },
  },
];
