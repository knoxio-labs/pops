...
function PhotoCell({
  ...
  return (
    ...
    >
      ...
      {index === 0 && (
        <span className="absolute bottom-1 left-1 text-2xs font-bold bg-app-accent text-app-accent-foreground px-1.5 py-0.5 rounded">
          Primary
        </span>
      )}
    </div>
...
export function SortablePhotoGrid({
  ...
  return (
    <div
      className="grid grid-cols-4 sm:max-md:grid-cols-5 md:grid-cols-6 gap-2"
      role="list"
