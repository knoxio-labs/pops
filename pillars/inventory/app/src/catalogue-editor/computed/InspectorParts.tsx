...
function NodeActions() {
  ...
  const isRoot = builder.selectedPath === ROOT_PATH;
  return (
    <div className="flex shrink-0">
      <Button
        ...
        onClick={() => builder.setPanel('insert')}
      >
      ...
      <Button
        ...
        onClick={() =>
          builder.change(clearAt(builder.root, builder.selectedPath), builder.selectedPath)
        }
      >
