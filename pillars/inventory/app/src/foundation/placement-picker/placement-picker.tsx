...
import { Input, KeyCombo, Popover, PopoverContent, PopoverTrigger } from '@pops/ui';
...
/** Renders the placement picker body without loading data or owning a query. */
...
/** Renders the placement picker panel from a popover trigger. */
