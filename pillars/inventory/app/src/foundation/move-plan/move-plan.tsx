/**
 * The preview a bulk move is confirmed from: the target, what moves, what
 * rides along inside, what is already there and what cannot go, all stated
 * before the button, which carries the real count.
 */
