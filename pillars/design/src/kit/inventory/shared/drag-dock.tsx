/**
 * What dragging looks like: the In hand strip that appears at the bottom of
 * the content while something is dragged, the highlight a target takes, and
 * the ghost that says how many are moving. A refused target says why in
 * words, not only with a cursor.
 */
