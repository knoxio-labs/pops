 ...
 */
import { deepContents, isWithin, samePlacement, targetName } from '../shared/placement-model';
...
export interface MovePlan {
  ...
  /** The target is marked full. A warning, not a refusal: full is a person's note. */
  targetFull: boolean;
}
