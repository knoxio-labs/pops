...
import { EditorHeader, EditorTabs, PublishBar, TypeIdentity } from './editor-frame';
...
function canPublish(mode: TypeEditorMode): boolean {
  return mode !== 'create' && mode !== 'archive' && mode !== 'stale' && mode !== 'destructive';
}
    ...
    <div className="grid gap-4 lg:grid-cols-12">
      ...
      <Card className="lg:col-span-6">
        ...
        <CardContent className="space-y-5">
          {creating ? <TypeIdentity creating /> : <EditorTabs mode={mode} />}
