...
export interface InventoryTableProps {
  ...
  onEdit?: (id: string) => void;
  onDeleteRequest?: (id: string) => void;
  /** Row click, in place of the app's route navigation. */
...
export function InventoryTable({
  ...
  return (
    <DataTable
      ...
      paginated
      defaultPageSize={20}
      // The canvas renders the surface in an iframe; a real navigate() would leave it, so row-open is a prop instead.
