...
/**
 * `INVENTORY_CONDITIONS` as `pillars/inventory`'s contract defines it
 * (`@pops/inventory` is off-limits to the playground, so the six values are
 * inlined rather than imported).
 */
const INVENTORY_CONDITIONS = ['Excellent', 'New', 'Good', 'Fair', 'Poor', 'Broken'] as const;
