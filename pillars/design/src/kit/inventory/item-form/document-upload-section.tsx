import { DocumentList, type DocumentItem } from '@/kit/inventory/documents/document-list';
import {
  DocumentUpload,
  type PendingDocumentFile,
} from '@/kit/inventory/documents/document-upload';
/**
 * Port of
 * `pillars/inventory/app/src/pages/item-form-page/sections/DocumentUploadSection.tsx`,
 * composing the already-ported `@/kit/inventory/documents` controls.
 */
