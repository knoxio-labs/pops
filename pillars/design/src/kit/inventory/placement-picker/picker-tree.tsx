/**
 * The drillable place tree: a breadcrumb of where the picker is, then the
 * places and containers one level down. Drilling is a chevron, picking is
 * the row, so opening Garage never moves anything into Garage by accident.
 */
...
/** The inline create row: "New place Linen press in Hallway". */
