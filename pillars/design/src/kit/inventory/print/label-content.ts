 ...
 * any mix of the QR, the code, the name, a box's contents and fields from
 * the items' types. Auto is the one choice that differs by kind: boxes get
 * the QR, name and code, everything else the QR and code.
 *
