...
interface NodeActionsProps {
  ...
  /** In place of the app's `<Link to="/inventory/reports/insurance?locationId=...">`: the canvas is an iframe, so a real navigation would leave the surface. */
  ...
  return (
    <div className="flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity ml-auto shrink-0">
      ...
      <PrimaryActions
        ...
        onDelete={onDelete}
        onInsuranceReport={onInsuranceReport}
      />
    </div>
  );
}
