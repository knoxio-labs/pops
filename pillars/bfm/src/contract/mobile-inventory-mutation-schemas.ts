 ...
 * it, not by this relay. The phone always supplies `catalogueRevision`, while
 * inventory temporarily accepts older non-mobile callers that omit it.
 */
export const MobileMutationSchema = z.object({
  ...
  catalogueRevision: z.number().int().min(1),
