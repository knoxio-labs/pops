 ...
 *
 * Forces the base URL to the shell's `/bfm-api` proxy path, which vite (dev)
 * and the production reverse proxy both map onto the deployed bfm pillar on
 * port 3014. This is unconditional — a `baseUrl` passed in here is discarded,
