/**
 * One line of an order, and what hangs off a line.
 *
 * Split from `purchase.ts` because this is a different grain: a purchase is
 * one order, an item is one thing bought, and the two have separate
 * vocabularies — a tag, a classification bound to its own provenance, a
 * serial-numbered unit. Nothing here mentions an order.
 *
