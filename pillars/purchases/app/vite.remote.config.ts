...
/**
 * Remote-bundle build for `@pops/app-purchases`: `purchases.js`, the ES module the shell's
 * runtime loader imports at the pillar's `assetsBaseUrl`, and `purchases.css`, the
...
export default defineConfig(
  remoteBuildConfig({ pillar: 'purchases', appRoot: import.meta.dirname })
);
