 ...
 *
 * Forces the base URL to the shell's `/media-api` proxy path, which vite
 * (dev) and the production reverse proxy both map onto the deployed media
 * pillar on port 3003. This is unconditional — a `baseUrl` passed in here is
