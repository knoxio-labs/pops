 ...
 *
 * The last test covers the property this pillar needs most. `makeClient` is
 * handed a freshly built app on nearly every call site, so the transport sees
 * far more distinct apps than the other pillars' do, and a dispatch that
 * guessed would answer from the wrong one.
 */
