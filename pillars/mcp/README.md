...
The tool surface — 60 tools over the `inventory`, `finance`, `contacts`, `media`, `cerebrum` and `purchases` pillars — lives in [`src/tools/`](src/tools/README.md).
...
# {"status":"ready","apiKeyConfigured":true,"tools":60}
```
