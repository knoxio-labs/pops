...
const ENTRY = path.join(APP_ROOT, 'dist/remote/lists.js');
...
describe('lists remote bundle', () => {
  ...
  // Both pages are lazy, so each keeps its own chunk and having lists in the
