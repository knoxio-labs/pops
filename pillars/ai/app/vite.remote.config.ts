...
/**
 * Remote-bundle build for `@pops/app-ai`: `ai.js`, the ES module the shell's
 * runtime loader imports at the pillar's `assetsBaseUrl`, and `ai.css`, the
 ...
 * not instead of it.
 */
export default defineConfig(remoteBuildConfig({ pillar: 'ai', appRoot: import.meta.dirname }));
