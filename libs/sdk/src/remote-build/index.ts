 ...
 * the shipped artefact was clean and nothing ever fired. The cost is that
 * `process . env`, legal JavaScript that no bundler emits, is not caught.
 *
...
export function findProcessGlobalUsage(
  ...
  const globalProcess = /(?<![.\w$])process\.[A-Za-z_$]/;
