...
| [Internal service auth](prds/internal-service-auth.md)             | Per-caller credentials on every internal boundary: retire the shared internal token and split the shared inbound key onto the registry's scoped service accounts (ADR-039 E22/E23)     | In progress (E22 done; E23 remains) |
