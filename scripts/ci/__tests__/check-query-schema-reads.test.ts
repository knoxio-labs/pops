...
describe('the other real pillars', () => {
  ...
  it('BFM_ROUTES names all 10 bfm mobile routes known to carry query fields', () => {
    expect(BFM_ROUTES.length).toBe(10);
  });
  ...
  it('INVENTORY_ROUTES names all 28 inventory routes known to carry query fields', () => {
    expect(INVENTORY_ROUTES.length).toBe(28);
  });
});
