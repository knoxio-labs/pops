...
/** Today's real count of inventory routes carrying query fields is 18. See {@link MIN_ROUTES_WITH_FIELDS}. */
...
export const INVENTORY_ROUTES = [
  ...
  },
  {
    method: 'get',
    path: '/containers',
    handlerFile: 'pillars/inventory/src/api/rest/containers-handlers.ts',
    handlerKey: 'list',
  },
  {
    method: 'get',
